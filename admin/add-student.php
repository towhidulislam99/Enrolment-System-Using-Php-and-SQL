<h1 class="text-primary" style="background: #133337; height: 70px;padding: 14px; color: white"><i class="fa fa-user-plus"></i> Add Student <small style="color: #FFFF00;"> Add New Student</small></h1>
