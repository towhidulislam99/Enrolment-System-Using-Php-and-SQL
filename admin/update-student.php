    ...
    <div class="col-sm-6">
        <form action="" method="POST" enctype="multipart/form-data" >
            ...
            <div class="form-group">
               ...
               <?php $getname = $db_row['photo'] 
                      
                       ?>
                <img class="img-thumbnail" style="width: 50px" src="student_images/<?php echo $db_row['photo']; ?> " alt=""/>
                <input type="file" name="photo" id="photo"  class="form-control" value="<?php echo $db_row['photo']; ?>"/>
