        ...
        <tbody>
            ...
            while ($row = mysqli_fetch_assoc($db_sinfo)) {
                ...
                <tr>
                    ...
                    <td>
                        <a href="index.php?page=update-department&id=<?php echo base64_encode($row['id']); ?>" class="btn btn-xs btn-warning"><i class="fa fa-pencil"></i> Edit</a>
                        
                        <a href="delete-department.php?id=<?php echo base64_encode($row['id']); ?>" class="btn btn-xs btn-danger"><i class="fa fa-trash"></i> Delete</a>
